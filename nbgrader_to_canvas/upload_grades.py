...
def upload_grades(lti=lti):
    ...
    with Gradebook("sqlite:////mnt/nbgrader/TEST_NBGRADER/grader/gradebook.db") as gb:
        ...
        nbgraderdata['assign_list'] = nb_assignments
        ...
        for nb_assignment in nb_assignments:
            ...
            for nb_student in nb_students:
                ...
                try:
                    ...
                    nb_student_and_score["assignment_name"] = nb_submission.name
    ...
    return nbgraderdata
    # return render_template('overview.htm.j2', progress=progress, BASE_URL=settings.BASE_URL)
